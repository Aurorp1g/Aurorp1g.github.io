...
function showWelcome() {
  ...
  try {
    ...
    document.getElementById("welcome-info").innerHTML =
      `<b><center>🎉 欢迎信息 🎉</center></b>&emsp;&emsp;<span>欢迎来自 <span style="color:var(--theme-color)">${pos}</span> 的小伙伴。${timeChange}您现在距离站长约 <span style="color:var(--theme-color)">${dist}</span> 公里，当前的IP地址为： <span style="color:var(--theme-color)">${ip}</span>， ${posdesc}</span>`;
  } catch (err) {
